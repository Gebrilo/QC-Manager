...
export const tasksApi = {
    list: (params?: { q?: string; search?: string; project_id?: string; project_ids?: string; status?: string; statuses?: string; assignee_id?: string; assignee_ids?: string; priority?: string; priorities?: string; source?: string; created_from?: string; created_to?: string; updated_from?: string; updated_to?: string; related_type?: string; related_id?: string }) => {
...
export const bugsApi = {
    list: (params?: { project_id?: string; project_ids?: string; status?: string; statuses?: string; severity?: string; severities?: string; assignee?: string; source?: string; q?: string; created_from?: string; created_to?: string; updated_from?: string; updated_to?: string; related_type?: string; related_id?: string; limit?: number; offset?: number }) => {
        const clean: Record<string, string> = {};
        if (params) {
            for (const [k, v] of Object.entries(params)) {
                if (v !== undefined && v !== null && v !== '') clean[k] = String(v);
...
export const userStoriesApi = {
    list: (params?: { page?: number; limit?: number; q?: string; search?: string; project_id?: string; project_ids?: string; status?: string; statuses?: string; author?: string; author_ids?: string; created_from?: string; created_to?: string; updated_from?: string; updated_to?: string; related_type?: string; related_id?: string; sort_by?: string; sort_order?: string }) => {
        const clean: Record<string, string> = {};
        if (params) {
            for (const [k, v] of Object.entries(params)) {
                if (v !== undefined && v !== null && v !== '') clean[k] = String(v);
...
export const testRunsApi = {
    listRecent: (params?: { q?: string; search?: string; project_id?: string; project_ids?: string; status?: string; statuses?: string; environment?: string; environments?: string; version_tag?: string; version_tags?: string; created_from?: string; created_to?: string; updated_from?: string; updated_to?: string; related_type?: string; related_id?: string }) => {
        const clean: Record<string, string> = {};
        if (params) {
            for (const [k, v] of Object.entries(params)) {
                if (v !== undefined && v !== null && v !== '') clean[k] = String(v);
        ...
        const query = new URLSearchParams(clean).toString();
        return fetchApi<TestRun[]>(`/test-executions/recent-uploads${query ? `?${query}` : ''}`);
    },
...
export const taskTestCaseLinksApi = {
    ...
    listBugsForTask: (taskId: string) =>
        fetchApi<{ data: Array<{ id: string; bug_id: string; task_id: string; relationship_type: string; source?: 'qc' | 'tuleap'; created_at: string; bug_display_id: string; bug_title: string; bug_status: string }> }>(`/tasks/${taskId}/bugs`),
    ...
    listBugsForTestCase: (testCaseId: string) =>
        fetchApi<{ data: Array<{ id: string; bug_id: string; test_case_id: string; relationship_type: string; source?: 'qc' | 'tuleap'; created_at: string; bug_display_id: string; bug_title: string; bug_status: string }> }>(`/test-cases/${testCaseId}/bugs`),
    ...
    listUserStoriesForTestCase: (testCaseId: string) =>
        fetchApi<{ data: Array<{ id: string; test_case_id: string; user_story_id: string; relationship_type: string; source?: 'qc' | 'tuleap'; created_at: string; 'user-story_display_id': string; 'user-story_title': string; 'user-story_status': string }> }>(`/test-cases/${testCaseId}/user-storys`),

    addUserStoryToTestCase: (testCaseId: string, userStoryId: string, relationshipType = 'verifies') =>
        fetchApi<{ data: { id: string; test_case_id: string; user_story_id: string; relationship_type: string } }>(`/test-cases/${testCaseId}/user-storys`, {
            method: 'POST',
    ...
    removeUserStoryFromTestCase: (testCaseId: string, userStoryId: string) =>
        fetchApi<{ success: boolean; message: string }>(`/test-cases/${testCaseId}/user-storys/${userStoryId}`, { method: 'DELETE' }),

    listTestCasesForUserStory: (userStoryId: string) =>
        fetchApi<{ data: Array<{ id: string; test_case_id: string; user_story_id: string; relationship_type: string; source?: 'qc' | 'tuleap'; created_at: string; 'test-case_display_id': string; 'test-case_title': string; 'test-case_status': string }> }>(`/user-stories/${userStoryId}/test-cases`),
    ...
    listBugsForUserStory: (userStoryId: string) =>
        fetchApi<{ data: Array<{ id: string; bug_id: string; user_story_id: string; relationship_type: string; source?: 'qc' | 'tuleap'; created_at: string; bug_display_id: string; bug_title: string; bug_status: string }> }>(`/user-stories/${userStoryId}/bugs`),
...
export const bugLinksApi = {
    ...
    listTestCases: (bugId: string) =>
        fetchApi<{ data: Array<{ id: string; bug_id: string; test_case_id: string; relationship_type: string; source: 'qc' | 'tuleap'; created_at: string; 'test-case_display_id': string; 'test-case_title': string; 'test-case_status': string }> }>(`/bugs/${bugId}/test-cases`),
    ...
    listTasks: (bugId: string) =>
        fetchApi<{ data: Array<{ id: string; bug_id: string; task_id: string; relationship_type: string; source?: 'qc' | 'tuleap'; created_at: string; task_display_id: string; task_name: string; task_status: string; project_id: string }> }>(`/bugs/${bugId}/tasks`),
    ...
    listUserStories: (bugId: string) =>
        fetchApi<{ data: Array<{ id: string; bug_id: string; user_story_id: string; relationship_type: string; source: 'qc' | 'tuleap'; created_at: string; 'user-story_display_id': string; 'user-story_title': string; 'user-story_status': string }> }>(`/bugs/${bugId}/user-storys`),

    addUserStory: (bugId: string, userStoryId: string, relationshipType = 'affects') =>
        fetchApi<{ data: { id: string; bug_id: string; user_story_id: string; relationship_type: string } }>(`/bugs/${bugId}/user-storys`, {
            method: 'POST',
            body: JSON.stringify({ user_story_id: userStoryId, relationship_type: relationshipType }),
        }),

    removeUserStory: (bugId: string, userStoryId: string) =>
        fetchApi<{ success: boolean; message: string }>(`/bugs/${bugId}/user-storys/${userStoryId}`, { method: 'DELETE' }),
};
