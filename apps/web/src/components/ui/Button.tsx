            ...
            <button
                className={cn(
                    "inline-flex items-center justify-center rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ring-offset-white dark:ring-offset-slate-950",
                    {
                        ...
                        "bg-rose-600/80 hover:bg-rose-600/95 dark:bg-rose-500/80 dark:hover:bg-rose-500/95 backdrop-blur-md text-white border border-white/20 dark:border-white/10 shadow-sm active:scale-95": variant === 'destructive',
                        "border border-slate-300 dark:border-slate-700 bg-white/50 backdrop-blur-md dark:bg-slate-900/50 hover:bg-slate-50/70 dark:hover:bg-slate-800/70 text-slate-700 dark:text-slate-300 shadow-sm transition-colors": variant === 'outline',
