                                ...
                                {loadingJourneys ? (
                                    ...
                                    <div className="space-y-3">
                                        {journeys.map(journey => {
                                            ...
                                            return (
                                                <Link key={journey.id} href={`/team/journeys/${selectedUser?.id}/${journey.journey_id}`} className="block bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors">
