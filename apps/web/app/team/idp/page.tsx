...
import { developmentPlansApi, IDPPlan, fetchApi } from '@/lib/api';
...
export default function ManageDevelopmentPlansPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">Development Plans</h1>
