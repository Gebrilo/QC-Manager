    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Test Runs</h1>
                        ...
                        <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/50 dark:to-slate-800/50 rounded-xl p-5 border border-slate-200/50 dark:border-slate-600/50">
                                ...
                                <table className="w-full text-xs">
                                    <thead>
                                        <tr className="bg-slate-200 dark:bg-slate-600">
                                            <th className="px-2 py-2 text-left font-semibold text-slate-700 dark:text-slate-200">Test Case ID</th>
                                            <th className="px-2 py-2 text-left font-semibold text-slate-700 dark:text-slate-200">Name</th>
                                            <th className="px-2 py-2 text-left font-semibold text-slate-700 dark:text-slate-200">Status</th>
                                            <th className="px-2 py-2 text-left font-semibold text-slate-700 dark:text-slate-200">Notes</th>
                                            <th className="px-2 py-2 text-left font-semibold text-indigo-600 dark:text-indigo-400">Module Name <span className="text-[9px] font-normal text-slate-400">(opt)</span></th>
                                            <th className="px-2 py-2 text-left font-semibold text-indigo-600 dark:text-indigo-400">Req ID <span className="text-[9px] font-normal text-slate-400">(opt)</span></th>
                                            <th className="px-2 py-2 text-left font-semibold text-indigo-600 dark:text-indigo-400">Est Hours <span className="text-[9px] font-normal text-slate-400">(opt)</span></th>
                                            <th className="px-2 py-2 text-left font-semibold text-indigo-600 dark:text-indigo-400">Is Retest <span className="text-[9px] font-normal text-slate-400">(opt)</span></th>
                                        </tr>
                                    </thead>
                                    <tbody className="bg-white dark:bg-slate-700">
                                        <tr className="border-b border-slate-200 dark:border-slate-600">
                                            ...
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">2</td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">No</td>
                                        </tr>
                                        <tr className="border-b border-slate-200 dark:border-slate-600">
                                            ...
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">1.5</td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">No</td>
                                        </tr>
                                        <tr className="border-b border-slate-200 dark:border-slate-600">
                                            <td className="px-2 py-2 font-mono text-slate-600 dark:text-slate-300">TC-003</td>
                                            <td className="px-2 py-2 text-slate-600 dark:text-slate-300">Profile Update</td>
                                            <td className="px-2 py-2"><span className="px-2 py-0.5 bg-amber-100 text-amber-700 rounded-full text-[10px] font-semibold">Blocked</span></td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">Env issue</td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">Profile</td>
                                            <td className="px-2 py-2 text-slate-400">-</td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">1</td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">No</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">0.5</td>
                                            <td className="px-2 py-2 text-slate-500 dark:text-slate-400">Yes</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="mt-3 p-3 bg-violet-50 dark:bg-violet-900/20 rounded-lg border border-violet-200 dark:border-violet-800">
                                <p className="text-xs font-semibold text-violet-700 dark:text-violet-300 mb-2">
                                    Optional columns unlock governance insights:
                                </p>
                                <table className="w-full text-[11px] text-violet-600 dark:text-violet-400">
                                    <tbody>
                                        <tr><td className="font-medium pr-2">Module Name</td><td>Blocked Test Analysis — per-module breakdown &amp; pivot alerts</td></tr>
                                        <tr><td className="font-medium pr-2">Requirement ID</td><td>Requirement Coverage % in Quality Metrics</td></tr>
                                        <tr><td className="font-medium pr-2">Est Hours</td><td>Effort-at-risk hours in Blocked Analysis</td></tr>
                                        <tr><td className="font-medium pr-2">Is Retest</td><td>Double-work (retest) hours tracking</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
