...
const SCHEMA = [
    ...
    { col: 'suite',         type: 'text',      required: false, example: 'Authentication / Login',                        desc: 'Optional grouping — maps to Suite Title (used to match against test suites)' },
...
function rowToApiPayload(row: ParsedRow) {
    ...
    return {
        ...
        suite_title: raw.suite || undefined,
