...
const ALL_PERMISSIONS = [
    { key: 'qc.dashboard.view', label: 'Dashboard', group: 'Dashboard' },
    { key: 'qc.tasks.view', label: 'View Tasks', group: 'Tasks' },
    { key: 'qc.tasks.create', label: 'Create Tasks', group: 'Tasks' },
    { key: 'qc.tasks.edit', label: 'Edit Tasks', group: 'Tasks' },
    { key: 'qc.tasks.delete', label: 'Delete Tasks', group: 'Tasks' },
    { key: 'qc.tasks.history.view', label: 'Task History', group: 'Tasks' },
    { key: 'qc.projects.view', label: 'View Projects', group: 'Projects' },
    { key: 'qc.projects.create', label: 'Create Projects', group: 'Projects' },
    { key: 'qc.projects.edit', label: 'Edit Projects', group: 'Projects' },
    { key: 'qc.projects.delete', label: 'Delete Projects', group: 'Projects' },
    { key: 'qc.resources.view', label: 'View Resources', group: 'Resources' },
    { key: 'qc.resources.create', label: 'Create Resources', group: 'Resources' },
    { key: 'qc.resources.edit', label: 'Edit Resources', group: 'Resources' },
    { key: 'qc.resources.delete', label: 'Delete Resources', group: 'Resources' },
    { key: 'qc.governance.view', label: 'View Governance', group: 'Governance' },
    { key: 'qc.governance.manage_gates', label: 'Manage Gates', group: 'Governance' },
    { key: 'qc.governance.approve_release', label: 'Approve Release', group: 'Governance' },
    { key: 'qc.testexecutions.view', label: 'View Test Runs', group: 'Test Executions' },
    { key: 'qc.testexecutions.create', label: 'Create Test Runs', group: 'Test Executions' },
    { key: 'qc.testexecutions.edit', label: 'Edit Test Runs', group: 'Test Executions' },
    { key: 'qc.testexecutions.delete', label: 'Delete Test Runs', group: 'Test Executions' },
    { key: 'qc.testresults.upload', label: 'Upload Test Results', group: 'Test Results' },
    { key: 'qc.testresults.delete', label: 'Delete Test Results', group: 'Test Results' },
    { key: 'qc.reports.view', label: 'View Reports', group: 'Reports' },
    { key: 'qc.reports.generate', label: 'Generate Reports', group: 'Reports' },
    { key: 'qc.admin.users.view', label: 'User Management', group: 'Admin' },
    { key: 'qc.admin.roles.view', label: 'Roles & Permissions', group: 'Admin' },
    { key: 'qc.admin.settings.view', label: 'Settings', group: 'Admin' },
    { key: 'qc.mywork.tasks.view', label: 'View My Tasks', group: 'My Work' },
    { key: 'qc.mywork.tasks.create', label: 'Create My Tasks', group: 'My Work' },
    { key: 'qc.mywork.tasks.edit', label: 'Edit My Tasks', group: 'My Work' },
    { key: 'qc.mywork.tasks.delete', label: 'Delete My Tasks', group: 'My Work' },
    { key: 'qc.mywork.dashboard.view', label: 'My Dashboard', group: 'My Work' },
    { key: 'qc.testcases.view', label: 'View Test Cases', group: 'Test Cases' },
    { key: 'qc.testcases.create', label: 'Create Test Cases', group: 'Test Cases' },
    { key: 'qc.testcases.edit', label: 'Edit Test Cases', group: 'Test Cases' },
    { key: 'qc.testcases.delete', label: 'Delete Test Cases', group: 'Test Cases' },
    { key: 'qc.testsuites.view', label: 'View Test Suites', group: 'Test Suites' },
    { key: 'qc.testsuites.create', label: 'Create Test Suites', group: 'Test Suites' },
    { key: 'qc.testsuites.edit', label: 'Edit Test Suites', group: 'Test Suites' },
    { key: 'qc.testsuites.delete', label: 'Delete Test Suites', group: 'Test Suites' },
    { key: 'qc.testsuites.reorder', label: 'Reorder Test Suites', group: 'Test Suites' },
    { key: 'qc.bugs.view', label: 'View Bugs', group: 'Bugs' },
    { key: 'qc.bugs.create', label: 'Create Bugs', group: 'Bugs' },
    { key: 'qc.bugs.edit', label: 'Edit Bugs', group: 'Bugs' },
    { key: 'qc.bugs.delete', label: 'Delete Bugs', group: 'Bugs' },
    { key: 'qc.journeys.view', label: 'View Journeys', group: 'Journeys' },
    { key: 'qc.journeys.assign', label: 'Assign Journeys', group: 'Journeys' },
    { key: 'qc.journeys.view_assigned', label: 'View Assigned', group: 'Journeys' },
    { key: 'qc.journeys.view_team_progress', label: 'View Team Progress', group: 'Journeys' },
    { key: 'qc.team.view', label: 'View Teams', group: 'Team' },
    { key: 'qc.team.manage', label: 'Manage Teams', group: 'Team' },
    { key: 'qc.quality.traceability.view', label: 'Traceability', group: 'Quality' },
];
