...
apiRouter.use('/test-suites', coverageLinks.testSuiteSide);
apiRouter.use('/test-executions', require('./routes/testExecutions'));
apiRouter.use('/test-executions/test-runs', coverageLinks.testRunSide);
...
apiRouter.use('/rbac', require('./routes/rbacScopes'));
