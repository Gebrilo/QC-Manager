...
// DELETE /teams/:id/projects/:qcProjectId — unassign project from team
router.delete('/:id/projects/:qcProjectId', requireAuth, requireRole('admin'), async (req, res, next) => {
    try {
        const { id, qcProjectId } = req.params;
        ...
        await db.query(`UPDATE projects SET team_id = NULL WHERE id = $1`, [qcProjectId]);
