...
// =====================================================
// GET /governance/release-readiness/:qcProjectId
// Get release readiness for a specific project
// =====================================================
router.get('/release-readiness/:qcProjectId', requireAuth, requirePermission('qc.governance.view'), async (req, res) => {
    try {
...
// =====================================================
// GET /governance/quality-risks/:qcProjectId
// Get quality risk assessment for a specific project
// =====================================================
router.get('/quality-risks/:qcProjectId', requireAuth, requirePermission('qc.governance.view'), async (req, res) => {
    try {
        const { qcProjectId } = req.params;
...
// =====================================================
// GET /governance/project-health/:qcProjectId
// Get comprehensive health summary for a specific project
// =====================================================
router.get('/project-health/:qcProjectId', requireAuth, requirePermission('qc.governance.view'), async (req, res) => {
    try {
        const { qcProjectId } = req.params;
...
// =====================================================
// GET /governance/gates/:qcProjectId
// Get quality gates configuration for a project
// =====================================================
router.get('/gates/:qcProjectId', requireAuth, requirePermission('qc.governance.view'), async (req, res) => {
    try {
        const { qcProjectId } = req.params;
...
// =====================================================
// GET /governance/approvals/:qcProjectId
// Get approval history for a project
// =====================================================
router.get('/approvals/:qcProjectId', requireAuth, requirePermission('qc.governance.view'), async (req, res) => {
    try {
        const { qcProjectId } = req.params;
        const result = await pool.query(
